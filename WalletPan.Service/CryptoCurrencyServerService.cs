...
namespace WalletPan.Service
{
    ...
    public class CryptoCurrencyServerService : CrudServiceInt<CryptoCurrencyServerEntity, GetCryptoCurrencyServer, NewCryptoCurrencyServer, EditCryptoCurrencyServer>, ICryptoCurrencyServerService
    {

        private readonly ICryptoCurrencyServerRepository _repository;

        public CryptoCurrencyServerService(ICryptoCurrencyServerRepository repository, IMapper mapper, IUnitOfWork unit, IStringLocalizer localizer) : base(repository, mapper, unit, localizer)
        {
        ...
        {
            var item = (NewCryptoCurrencyServer)newDto;
                ...
                if (existedData != null)
                {
                    ...
                    res.Message.Add(string.Format(Localizer["Messages.RepeatedRecord"], Localizer["Title"], Localizer["CryptoCurrencyServerEntity"]));
                }
