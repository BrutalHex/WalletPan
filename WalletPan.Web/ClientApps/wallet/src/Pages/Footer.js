     ...
     render() {
       ...
       const   list = [{
        ...
        const res=  list.map((item,index)=>{
                  return (
                      <div key={"footer_head" + index.toString()}  className="col-12 col-sm-6 col-md-3 col-lg-3 col-xl-3">
                   <div className="col-12 footer-links-header"> {item.title}</div>
                {

  item.links.map((inner,ind)=>{

      return (<div key={"footer_body" + ind.toString()}  className="col-12 footer-links">
